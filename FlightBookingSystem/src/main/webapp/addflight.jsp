...
<title>FlyAway - Add Flight</title>
...
Source : <input type="text" placeholder="Source" name="sourceflight">
Destination : <input type="text" placeholder="Destination" name="destinationflight">
Airlines : <input type="text" placeholder="Airlines" name="airlines">
